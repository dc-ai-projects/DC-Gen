...
"""
python -m dc_ai.aecore.data_provider.vlm_caption

torchrun --nnodes=1 --nproc_per_node=8 -m dc_ai.aecore.data_provider.vlm_caption vlm=OpenGVLab/InternVL2-26B
torchrun --nnodes=1 --nproc_per_node=8 -m dc_ai.aecore.data_provider.vlm_caption vlm=OpenGVLab/InternVL2-26B data_provider=ImageNetEval
torchrun --nnodes=1 --nproc_per_node=8 -m dc_ai.aecore.data_provider.vlm_caption vlm=OpenGVLab/InternVL2-26B data_provider=DataCompHQEval
torchrun --nnodes=1 --nproc_per_node=8 -m dc_ai.aecore.data_provider.vlm_caption vlm=OpenGVLab/InternVL2-26B data_provider=MapillaryVistasEval
torchrun --nnodes=1 --nproc_per_node=8 -m dc_ai.aecore.data_provider.vlm_caption vlm=OpenGVLab/InternVL2-26B data_provider=MJHQEval
torchrun --nnodes=1 --nproc_per_node=8 -m dc_ai.aecore.data_provider.vlm_caption vlm=OpenGVLab/InternVL2-26B data_provider=MJV6Eval
torchrun --nnodes=1 --nproc_per_node=8 -m dc_ai.aecore.data_provider.vlm_caption vlm=OpenGVLab/InternVL2-26B data_provider=PexelsEval
torchrun --nnodes=1 --nproc_per_node=8 -m dc_ai.aecore.data_provider.vlm_caption vlm=OpenGVLab/InternVL2-26B data_provider=SAMEval
torchrun --nnodes=1 --nproc_per_node=8 -m dc_ai.aecore.data_provider.vlm_caption vlm=OpenGVLab/InternVL2-26B data_provider=TextCapsEval
torchrun --nnodes=1 --nproc_per_node=8 -m dc_ai.aecore.data_provider.vlm_caption vlm=OpenGVLab/InternVL2-26B data_provider=WiderFaceEval
torchrun --nnodes=1 --nproc_per_node=8 -m dc_ai.aecore.data_provider.vlm_caption vlm=OpenGVLab/InternVL2-26B data_provider=IGDataTextEval
"""
