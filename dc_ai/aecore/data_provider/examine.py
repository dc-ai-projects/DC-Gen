...
class DataProviderExaminationDistributer:
    ...
    def build_dataset(self) -> Dataset:
        assert self.cfg.dataset in possible_datasets, f"dataset {self.cfg.dataset} is not supported"
        dataset = possible_datasets[self.cfg.dataset](size_transform=IdentityTransform(), transform=IdentityTransform())
        return dataset
