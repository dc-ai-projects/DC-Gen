# Copied from GEdit Bench introduced by Shiyu Liu et. al. See https://github.com/stepfun-ai/Step1X-Edit.
...
class VIEScore:
    def __init__(self, backbone="gpt4o", task="t2i", key_path=None, device="cuda:0") -> None:
        self.task = task
