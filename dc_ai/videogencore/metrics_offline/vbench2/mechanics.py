...
# This file is modified from https://github.com/Vchitect/VBench/blob/master/VBench-2.0/vbench2/mechanics.py, with the following changes:
# - support distributed evaluation

from vbench2.mechanics import LLaVA_Video
