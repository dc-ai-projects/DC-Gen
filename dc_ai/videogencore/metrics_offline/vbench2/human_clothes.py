...
# This file is modified from https://github.com/Vchitect/VBench/blob/master/VBench-2.0/vbench2/human_clothes.py, with the following changes:
# - support distributed evaluation

import os

from vbench2.human_clothes import LLaVA_Video
...
def main():
    ...
    print(
        compute_human_clothes(
            "tmp/tmp.json",
            device,
            {"llava": os.path.expanduser("~/.cache/vbench2/lmms-lab/LLaVA-Video-7B-Qwen2")},
        )
    )
...
"""
python -m dc_ai.videogencore.metrics_offline.vbench2.human_clothes
"""
