...
# This file is modified from https://github.com/Vchitect/VBench/blob/master/VBench-2.0/vbench2/motion_rationality.py, with the following changes:
# - support distributed evaluation


from vbench2.motion_rationality import LLaVA_Video
