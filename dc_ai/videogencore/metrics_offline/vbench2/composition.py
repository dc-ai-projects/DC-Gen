...
# This file is modified from https://github.com/Vchitect/VBench/blob/master/VBench-2.0/vbench2/composition.py, with the following changes:
# - support distributed evaluation

from vbench2.composition import LLaVA_Video
