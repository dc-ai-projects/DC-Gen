...
# This file is modified from https://github.com/Vchitect/VBench/blob/master/VBench-2.0/vbench2/thermotics.py, with the following changes:
# - support distributed evaluation


from vbench2.thermotics import LLaVA_Video
