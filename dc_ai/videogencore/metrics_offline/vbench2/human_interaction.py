...
# This file is modified from https://github.com/Vchitect/VBench/blob/master/VBench-2.0/vbench2/human_interaction.py, with the following changes:
# - support distributed evaluation

from transformers import AutoModelForCausalLM, AutoTokenizer
from vbench2.human_interaction import LLaVA_Video
