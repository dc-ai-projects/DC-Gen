# We utilize the code for t5 text encoder implemented by Wan Team.
...
# The original implementation is by Wan Team, licensed under the Apache License 2.0. See https://github.com/Wan-Video/Wan2.1/blob/main/wan/modules/t5.py.
...
class T5Encoder(nn.Module):
    def __init__(
        ...
        self.blocks = nn.ModuleList(
            [T5SelfAttention(dim, dim_attn, dim_ffn, num_heads, num_buckets, shared_pos) for _ in range(num_layers)]
        )
