...
__all__ = ["VideoGenCoreEvalDataProviderConfig", "VideoGenCoreEvalDataProvider"]


@dataclass
class VideoGenCoreEvalDataProviderConfig(BaseDataProviderConfig):
    pass


class VideoGenCoreEvalDataProvider(BaseDataProvider):
    def __init__(self, cfg: VideoGenCoreEvalDataProviderConfig):
        super().__init__(cfg)
        self.cfg: VideoGenCoreEvalDataProviderConfig
