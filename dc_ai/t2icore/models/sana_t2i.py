...
class SanaT2I(BaseT2IDiffusionModel):
    ...
    def build_model(self):
        from .ops.caption_embed import CaptionEmbedder
        from .ops.input_embed import PatchEmbedMS
        from .ops.timestep_embed import TimestepEmbedder
        ...
        self.y_embedder = CaptionEmbedder(
            ...
            text_encoder_id=self.cfg.text_encoder_id,
        )
    ...
    def forward_train(
        ...
        mask = text_embed_info[self.cfg.text_encoder_id]["text_embedding_masks"]
