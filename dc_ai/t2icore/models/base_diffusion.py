...
from .base import BaseT2IModel, BaseT2IModelConfig
...
class BaseT2IDiffusionModel(BaseT2IModel):
    def __init__(self, cfg: BaseT2IDiffusionModelConfig):
        ...
        if cfg.eval_scheduler == "DPMS":
            ...
            from ..scheduler.flux2_scheduler import Flux2Scheduler
        ...
        elif cfg.eval_scheduler == "FluxScheduler":
            from ..scheduler.flux_scheduler import FluxScheduler
        ...
        elif cfg.train_scheduler == "FlowMatchEulerDiscreteScheduler":
